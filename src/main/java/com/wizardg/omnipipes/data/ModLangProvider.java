...
public class ModLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModItems.TAG_FILTER.get(), "Tag Filter");
        add(ModItems.PIPE_CONFIGURATOR.get(), "Pipe Configurator");
        add("tooltip.omni_pipes.configurator.mode", "Mode: %s");
        add("tooltip.omni_pipes.configurator.mode.configure", "Configuration");
        add("tooltip.omni_pipes.configurator.mode.copy", "Copy/Paste Settings");
        add("tooltip.omni_pipes.configurator.empty", "Nothing copied yet");
        add("tooltip.omni_pipes.configurator.saved", "Settings Saved");
        add("tooltip.omni_pipes.configurator.copy_hint", "Shift + right-click a connection to copy, right-click one to paste");
        add("tooltip.omni_pipes.configurator.configure_hint", "Right-click a side to switch it off or back on, aim at the pipe's center for a side without an arm");
        add("tooltip.omni_pipes.configurator.dismantle_hint", "Shift + right-click a pipe to pick it up, upgrades included");
        add("tooltip.omni_pipes.configurator.switch_hint", "Shift + right-click the air to switch modes");
        add("message.omni_pipes.configurator.disabled", "%s side disconnected");
        add("message.omni_pipes.configurator.enabled", "%s side can connect again");
        add("message.omni_pipes.configurator.not_connection", "That side isn't connected to a block");
        add("message.omni_pipes.configurator.copied", "Copied the %s connection");
        add("message.omni_pipes.configurator.pasted", "Pasted onto the %s connection");
        add("message.omni_pipes.configurator.nothing_copied", "Nothing copied yet, shift + right-click a connection first");
        add("tooltip.omni_pipes.tag_filter.empty", "Right-click to add item or fluid tags");
        add("tooltip.omni_pipes.tag_filter.hint", "Put in a pipe filter slot to match everything in these tags");
        add("screen.omni_pipes.slot.tier", "Tier Upgrade Slot");
        add("screen.omni_pipes.slot.tier.tooltip", "Tier 1-4 or Creative Upgrade, sets how fast and how much this side extracts");
        add("screen.omni_pipes.slot.type", "Type Upgrade Slot");
        add("screen.omni_pipes.slot.type.tooltip", "Lets this side extract another type, like fluids or energy");
        add("screen.omni_pipes.tag_filter.matching", "Matching tags (Tab fills in the first)");
        add("screen.omni_pipes.tag_filter.scroll", "%s-%s of %s, scroll for more");
        add("screen.omni_pipes.tag_filter.input", "Tag");
        add("screen.omni_pipes.tag_filter.add", "Add");
        add("screen.omni_pipes.tag_filter.remove", "Click to remove");
        add("screen.omni_pipes.tag_filter.pick", "Click to add");
        add("screen.omni_pipes.tag_filter.list", "Tags (%s/%s)");
        add("screen.omni_pipes.tag_filter.other_hand", "Tags of the item in your other hand");
        add("screen.omni_pipes.tag_filter.invalid", "Not a valid tag id");
        add("screen.omni_pipes.tag_filter.unknown", "No item or fluid tag with that name");
        add("screen.omni_pipes.tag_filter.duplicate", "Already in the list");
        add("screen.omni_pipes.tag_filter.full", "The list is full");
